                ...
                <div className="mt-8 w-full space-y-4">
                  {recentScan ? (
                    <div className="space-y-4">
                      <div className={`p-4 rounded-xl flex items-center gap-3 border ${recentScan.status === 'success' ? 'bg-emerald-50 border-emerald-200 text-emerald-700' : 'bg-rose-50 border border-rose-200 text-rose-700'}`}>
                      ...
                      {recentScan.student && (
                        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 relative overflow-hidden shadow-sm text-left animate-in fade-in duration-200">
                          ...
                          <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-slate-200/60 text-[10px] relative z-10">
                            ...
                            <div>
                              ...
                              <p className="text-slate-700 font-bold mt-0.5 truncate">{recentScan.student.guardianName || 'None'}</p>
                            </div>
                          </div>
                        </div>
                      )}
